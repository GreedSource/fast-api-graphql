...
class HelloResolver:
    ...
    def resolve_hello(self, _: object, info: GraphQLResolveInfo) -> str:
        return "¡Hola desde Ariadne!"

    async def hello_stream_source(self, _: object, info: GraphQLResolveInfo) -> AsyncGenerator[str, None]:
        count = 0
        while True:
    ...
    def hello_stream_resolver(self, message: str, info: GraphQLResolveInfo) -> str:
        return message

    def get_resolvers(self) -> list[QueryType | SubscriptionType]:
